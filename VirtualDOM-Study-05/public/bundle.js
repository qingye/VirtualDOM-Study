...
var DemoComp = /*#__PURE__*/function (_Component) {
  ...
  function DemoComp(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "interval", function () {
      setInterval(function () {
        _this.setState({
          name: 'chris-' + Math.floor(Math.random() * 100)
        });
      }, 2000);
    });
  ...
  _createClass(DemoComp, [{
    key: "render",
    value: function render() {
      return v("div", null, v("div", null, "This is DemoComp....props = ", this.props.value), v("div", null, "DemoComp.state.name = ", this.state.name));
    }
  }]);
