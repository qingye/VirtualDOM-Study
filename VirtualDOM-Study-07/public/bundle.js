...
var pendingRenderQueue = [];

var enqueue = function enqueue(component) {
...
var doRender = function doRender() {
  ...
  var uniques = _toConsumableArray(new Set(pendingRenderQueue)); // 清空队列


  pendingRenderQueue.splice(0, pendingRenderQueue.length); // 依次更新各个组件

  uniques.forEach(function (comp) {
